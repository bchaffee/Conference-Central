...
# - - - Session objects - - - - - - - - - - - - - - - - - - -
    ...
    def getSessionsBySpeaker(self, request):
        """Return all sessions given by speaker in all conferences"""
    ...
    @endpoints.method(CONF_GET_REQUEST, SessionForms,
                      http_method='GET',
                      name='getConferenceSessionFeed')
    def getConferenceSessionFeed(self, request):
        """Return feed of sessions occurring same day/later."""
